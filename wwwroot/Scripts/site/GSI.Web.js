...
(function (GSI) {
    ...
    })(Administration = GSI.Administration || (GSI.Administration = {}));
})(GSI || (GSI = {}));
var GSI;
(function (GSI) {
    var Administration;
...
(function (GSI) {
    ...
    (function (Administration) {
        ...
        [['SettingKey', function () { return Serenity.StringEditor; }], ['SettingValue', function () { return Serenity.StringEditor; }]].forEach(function (x) { return Object.defineProperty(SettingsForm.prototype, x[0], { get: function () { return this.w(x[0], x[1]()); }, enumerable: true, configurable: true }); });
    })(Administration = GSI.Administration || (GSI.Administration = {}));
})(GSI || (GSI = {}));
var GSI;
(function (GSI) {
    ...
    (function (Administration) {
        ...
        (function (SettingsRow) {
            ...
            SettingsRow.nameProperty = 'SettingKey';
...
(function (GSI) {
    ...
    })(Membership = GSI.Membership || (GSI.Membership = {}));
})(GSI || (GSI = {}));
var GSI;
(function (GSI) {
    var Membership;
...
(function (GSI) {
    ...
    })(Organization = GSI.Organization || (GSI.Organization = {}));
})(GSI || (GSI = {}));
var GSI;
(function (GSI) {
    var Organization;
...
(function (GSI) {
    ...
    })(Authorization = GSI.Authorization || (GSI.Authorization = {}));
})(GSI || (GSI = {}));
var GSI;
(function (GSI) {
    var Administration;
...
(function (GSI) {
    ...
    (function (LanguageList) {
        function getValue() {
            var result = [];
            for (var _i = 0, _a = GSI.Administration.LanguageRow.getLookup().items; _i < _a.length; _i++) {
                var k = _a[_i];
                if (k.LanguageId !== 'en') {
    ...
    })(LanguageList = GSI.LanguageList || (GSI.LanguageList = {}));
})(GSI || (GSI = {}));
...
(function (GSI) {
    ...
    (function (ScriptInitialization) {
        ...
        Serenity.EntityDialog.defaultLanguageList = GSI.LanguageList.getValue;
    })(ScriptInitialization = GSI.ScriptInitialization || (GSI.ScriptInitialization = {}));
})(GSI || (GSI = {}));
var GSI;
(function (GSI) {
    ...
    GSI.BasicProgressDialog = BasicProgressDialog;
})(GSI || (GSI = {}));
var GSI;
(function (GSI) {
    var Common;
    (function (Common) {
        var BulkServiceAction = /** @class */ (function () {
            ...
            BulkServiceAction.prototype.createProgressDialog = function () {
                this.progressDialog = new GSI.BasicProgressDialog();
...
(function (GSI) {
    ...
    })(DialogUtils = GSI.DialogUtils || (GSI.DialogUtils = {}));
})(GSI || (GSI = {}));
var GSI;
(function (GSI) {
    var Common;
...
//# sourceMappingURL=GSI.Web.js.map